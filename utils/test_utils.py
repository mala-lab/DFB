...
def mk_id_ood(args, logger):
    ...
    in_set = tv.datasets.CIFAR100(root=args.in_datadir,train=False,download=True,transform=val_tx)
    out_set = tv.datasets.CIFAR10(root=args.out_datadir,train=False,download=True,transform=val_tx)
